...
public:
    explicit DescriptorBuilder(vk::Device& device);
    ...
    void write_image(u32 dstArrayElement, vk::ImageView image, vk::Sampler sampler, vk::ImageLayout layout, vk::DescriptorType type);
